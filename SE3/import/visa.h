...
/* - Micran attributes */
#define VI_ATTR_MICS_BREAK_PACKET   (0x3FFF0246UL) // Send head and body separately
#define VI_ATTR_MICS_FULL_HEAD      (0x3FFF0247UL) // Always show all attributes in packet head
#define VI_ATTR_MICS_BODY           (0x3FFF0248UL) // Command body display mode
#define VI_ATTR_SUPPRESS_MICS       (0x3FFF0249UL) // Suppress MICS commands conversion (send & recv data as is)   (0x3FFF0249UL) // Suppress MICS commands conversion (send & recv data as is)

#define VI_ATTR_FIND_USER_IP        (0x3FFF024AUL)          // Instruments user IP (used for viFindList)
#define VI_ATTR_FIND_MANF_NAME      VI_ATTR_MANF_NAME
#define VI_ATTR_FIND_MODEL_NAME     VI_ATTR_MODEL_NAME
#define VI_ATTR_FIND_SERIAL_NUM     VI_ATTR_USB_SERIAL_NUM
#define VI_ATTR_FIND_LOCK_STATE     VI_ATTR_RSRC_LOCK_STATE // Instruments lock state (used for viFindList)
